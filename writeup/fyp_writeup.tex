...
Finally, is there any advantage to combining presentations? It's been known for some time that seeing multiple distinct examples can lead to better generalization in some cases \cite{Gick1983}. Previous work has found that using multiple external representations may be beneficial \cite{Ainsworth2006,Rau2016}, and in particular that fading details from concrete to abstract may be beneficial \cite{Goldstone2005,Fyfe2014}. Are multiple presentations more broadly beneficial? \par  %%TODO: last question needs editing to be more specific and pointed
