...
Second, do the details of how the presentation is made concrete matter? The work of \citeA{Kaminski2008} and much of the following work has focused on a single axis of concrete vs. abstract. A few authors have acknowledeged that there are other features that may ``concrete'' but irrelevant  \cite<e.g.>{Belenky2014}. However, is there really a single concrete vs. abstract axis which can change what is learned from a presentation, or is the space of possible presentations more complicated? Can different ``concrete'' ways of presenting a concept result in differential understanding? \par
