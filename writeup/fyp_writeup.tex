...
\title{Presentations and their idiosyncracies: how different presentations of a mathematical concept affect learning of a mathematical system}
\shorttitle{Presentations and their idiosyncracies}
...
\date{}
\abstract{Previous research has examined how different presentations of a mathematical concept affect generalizable learning of that concept \cite<e.g.>{Kaminski2008}. This research has generally been limited to exploring the effects of presentation only on transfer to isomorphic instances of the single concept presented. However, mathematics is a richly structured field, where concepts are deeply interconnected, and there are many distinct aspects of understanding of a single mathematical concept, such as the ability to use it in practice vs. the ability to prove theorems about it. Which aspects of understanding are supported by a presentation may depend on how it presents the concept. Here, we explore how different presentations of a concept can affect learning of subsequent concepts and aspects of understanding. Using the domain of elementary group theory, we teach participants a group operation using a visuospatial or an arithmetic presentation, or both. We then teach them concepts that build upon this operation. We demonstrate that our presentations differentially support learning various aspects of the system presented, with each presentation having advantages and disadvantages, because each connects to different systems of reasoning that students are familiar with. We argue that these connections to extant knowledge systems are a more relevant feature for evaluating presentations than the more common concrete-abstract distinction. Furthermore, instead of pursuing a single ideal presentation, we show that presenting both presentations in the same amount of time and encouraging participants to recognize the relationship between them improves performance, at least for some participants.} 
