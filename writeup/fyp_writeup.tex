...
Similary, there are many different possible meanings of the word ``abstract.'' \citeA{Hazzan1999} has described several of these, ranging from ``abstract'' as the opposite of ``concrete'' as defined by \citeA{Wilensky1991} to ``abstract'' as an object rather than a process understanding of a concept. Which of these is meant by ``abstract'' when describing a presentation? To avoid these definitional conundrums, instead of thinking of presentations in terms of ``concrete'' and ``abstract,'' we prefer to think about how presentations may support links to systems of thinking that students already understand.\par 
