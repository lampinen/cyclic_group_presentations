...
We performed the experiments on Amazon's Mechanical Turk, using high-reputation participants (over 85\% approval rate), and using participant tracking (so we could run follow-up and replication studies on Mechanical Turk without having the same participants participate and contaminate the results). Experiment 1 had $n = 50$ participants per group, $N = 100$ total; experiment 2 had $n = 50$, $N = 150$; and experiment 3 had $n = 100$, $N = 300$.
