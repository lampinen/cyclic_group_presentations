...
Our results highlight the difficulty in organizing presentations into a single concrete-abstract continuum. While \citeA{Belenky2014} noted that there are irrelevant details that can be added to a presentation without making a concept more concrete, we highlight that there are multiple ways of making a concept concrete. Neither of our presentations was clearly more concrete than the other, instead they grounded the material in different ways. The polygon presentation related the group operation to a visuospatial concept, and the modular presentation related it more directly to arithmetic operations which the subjects knew. Both of these make the group operation more ``concrete'' in some sense, but they do so in different ways. Furthermore, this is not just a cosmetic difference, our results suggest that these different groundings significantly altered the way subjects were able to learn related concepts later. Rather than thinking of concrete vs. abstract presentations as a single axis, we should recognize that there are many ways of making material concrete that may differentially impact learning. \par
