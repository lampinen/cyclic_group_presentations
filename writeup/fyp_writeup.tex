...
These findings contribute to the ongoing exploration of the role of concrete and abstract presentations in math cognition, illustrating that even presentations which are not clearly more ``abstract'' or ``concrete'' than one another may have different advantages and disadvantages. Furthermore, ``abstract'' vs. ``concrete'' is a misleading dichotomy, because there are many ways of making a concept concrete, and different ``concrete'' presentations may make different aspects of understanding more salient and easily understandable. Because of this, trying to find a single best type of presentation may be futile. \par
