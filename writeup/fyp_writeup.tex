...
It remains a question for future research how the strategy could be altered to encourage more uniform improvement across all question types and participants. Nevertheless, these results suggest that teaching multiple presentations may be beneficial to students' overall understanding. 
...
None of the presentations seemed to encourage formal or general understanding particularly well, as evidenced by the low overall performance on the order $n$ questions. (E.g., despite the fact that performance on the inverse questions was around 75\% on average, only about one third of the participants were able to articulate the general formula for computing an inverse in cyclic group of unspecified order $n$.) This may be representative of the more general separation between these aspects of understanding, or it may simply reflect the fact that this study was too short for participants understanding of specific groups to develop into a more general understanding.  \par
...
It is interesting to ask whether simple practice with a concept can lead to formalization, and if so, under what circumstances. Do students acquire sudden insights after computing inverses for some time, such that they can articulate the formula for the inverse? Do they accumulate knowledge more gradually with practice, so that they can articulate the procedure in words before they can articulate it formally? How does this depend on prior mathematical experience? How does it depend on the presentation of the concepts in question? Can hybrid presentations help by encouraging more abstract thought about the concept? These questions provide a fascinating direction for future research. 
\section{Conclusion}
