...
\begin{itemize}
\item Does it allow students to understand that particular instance of the concept? (Does it allow students to learn the group operation in a group of a specific size?) 
\item Does it allow them to understand further concepts that build upon the base concept, within the original instance? (Does it allow them to understand inverses and generators in the cyclic group of the original size?)
...
\item Does it allow them to express and understand these generalizations using formal mathematical expressions and language? (Can they write a formula for the inverse in a generic group of order $n$, or correctly assess formal statements about which elements are generators?)
\end{itemize}
