...
\end{itemize}
Furthermore, we hypothesized that the hybrid group would achieve approximately the maximum performance of the two groups, i.e.: %%TODO: contrast this with averaging or confusion hypotheses
\begin{itemize}
