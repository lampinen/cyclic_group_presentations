//For fyp experiment instructions with manipulable polygon and arrow diagram
//Code adapted from jspsych demos

(function($) {
    jsPsych['polygon-arrow-instructions'] = (function() {
	...
	display_element.append('<div id="polygon-question-div">'+trial.text+'<br /><br /></div>');
	var end_function = function() {
		...
		"id": "polygon-instructions-done-btn",
		"class": "polygon-arrow-instructions",
		"html": "Continue",
		"click": end_function 
	}));
