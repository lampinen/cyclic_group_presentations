//For fyp experiment feedback with manipulable polygon and arrow diagram
//Code adapted from jspsych demos

(function($) {
    jsPsych['polygon-arrow-feedback'] = (function() {
        ...
        plugin.create = function(params) {
		    ...
		    "nsides": params.nsides || 6, //Number or 'n' for the arbitrary polygon sketch
                    ...
                    "incorrect_text": (typeof params.correct_text === 'undefined') ? 'Sorry, that was incorrect.' : params.incorrect_text,
	...
	var orientation_history = [];
        ...
        if (prev_data.response == prev_data.correct_response) {
                ...
                display_element.append('<div id="polygon-question-div">'+trial.correct_text+'<br /><br /></div>');
        } 
        else {
                text_displayed = trial.incorrect_text;  
                display_element.append('<div id="polygon-question-div">'+trial.incorrect_text+'<br /><br /></div>');
        }
...
//			jsPsych.data.displayData('json');
		...
		"id": "polygon-feedback-done-btn",
		"class": "polygon-arrow-feedback",
		"html": "Continue",
		"click": end_function 
	}));
