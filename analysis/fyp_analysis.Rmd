...
ggplot(data=summarized_data,aes(condition,percent_correct.mean,fill=condition)) +
  ...
  ggtitle("Operation Order 6 (Learning) Results")
```
...
ggplot(data=summarized_data,aes(condition,percent_correct.mean,fill=condition)) +
  geom_bar(stat="identity") +
  geom_errorbar(aes(ymax=percent_correct.mean+percent_correct.sem,ymin=percent_correct.mean-percent_correct.sem)) +
  annotate("text",x=1.5,y=1.0,label='p = 0.38',alpha=0.5)+
  ggtitle("Operation Order 9 (Testing) Results")
```
...
ggplot(data=summarized_data,aes(is_0,percent_correct.mean,fill=condition)) +
  ...
  annotate("text",x=1,y=1.0,label='p = 0.21',alpha=0.5)+
  annotate("text",x=2,y=1.0,label='p < 0.001',alpha=0.5)+
...
ggplot(data=summarized_data,aes(condition,percent_correct.mean,fill=condition)) +
  geom_bar(stat="identity",position="dodge") +
  geom_errorbar(aes(ymax=percent_correct.mean+percent_correct.sem,ymin=percent_correct.mean-percent_correct.sem),position="dodge") +
  annotate("text",x=1.5,y=1.0,label='p = 0.02',alpha=0.5)+
...
ggplot(data=summarized_data,aes(generator,percent_correct.mean,fill=condition)) +
  geom_bar(stat="identity",position="dodge") +
  geom_errorbar(aes(ymax=percent_correct.mean+percent_correct.sem,ymin=percent_correct.mean-percent_correct.sem),position="dodge") +
  annotate("text",x=1.0,y=1.0,label='p = 0.048',alpha=0.5)+
  annotate("text",x=2.0,y=1.0,label='p = 0.002',alpha=0.5)+
...
ggplot(data=summarized_data,aes(generator,percent_correct.mean,fill=condition)) +
  geom_bar(stat="identity",position="dodge") +
  geom_errorbar(aes(ymax=percent_correct.mean+percent_correct.sem,ymin=percent_correct.mean-percent_correct.sem),position="dodge") +
  annotate("text",x=1.0,y=1.0,label='p = 0.98',alpha=0.5)+
  annotate("text",x=2.0,y=1.0,label='p = 0.046',alpha=0.5)+
...
ggplot(data=summarized_data,aes(condition,percent_correct.mean,fill=condition)) +
  geom_bar(stat="identity",position="dodge") +
  geom_errorbar(aes(ymax=percent_correct.mean+percent_correct.sem,ymin=percent_correct.mean-percent_correct.sem),position="dodge") +
  annotate("text",x=1.5,y=1.0,label='p = 0.004',alpha=0.5)+
