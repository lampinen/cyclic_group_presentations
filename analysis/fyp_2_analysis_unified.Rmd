...
print(paste("theta: ",theta,", phi: ",phi,', BIC: ', log(50)-2*log_likelihood_of_full_data(hierarchical_data,theta,phi)))
...
print(paste("theta: ",theta,", phi: ",phi,', BIC: ', 2*log(50)-2*log_likelihood_of_full_data(hierarchical_data,theta,phi)))
