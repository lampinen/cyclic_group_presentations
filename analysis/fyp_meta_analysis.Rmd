...
for (var in c('question_typegenerator_true_%i.conditionpolygon','question_typeinverse_nonzero_%i.conditionpolygon')) {
  print(var)
...
for (var in c('question_typegenerator_true_%i.conditionhybrid','question_typeinverse_nonzero_%i.conditionhybrid','question_typeinverse_zero_%i.conditionhybrid','question_typeinverse_nonzero_%i.conditionpolygon')) {
  print(var)
