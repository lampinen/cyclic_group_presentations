...
temp_data = whichrep_data[!is.na(whichrep_data$whichrep_polygon) & grepl('inverseof0',gsub(' ','',whichrep_data$question)),] %>% group_by(score,whichrep_polygon,whichrep_modular) %>% summarize(count = n()) %>% complete(whichrep_polygon,whichrep_modular,score,fill=list(count=0))
ggplot(data=temp_data,aes(x=whichrep_polygon,y=whichrep_modular)) +
  geom_tile(aes(fill=count)) +
  scale_fill_continuous(low="#000044",high="#FF5555") +
  labs(x = "Polygon Rating",y="Modular Rating",title="Inverse of Zero: Which Representation?")+
  facet_grid(.~score,labeller=label_both)+ 
...
temp_data = whichrep_data[!is.na(whichrep_data$whichrep_polygon) & grepl('inverseof4',gsub(' ','',whichrep_data$question)),] %>% group_by(score,whichrep_polygon,whichrep_modular) %>% summarize(count = n()) %>% complete(whichrep_polygon,whichrep_modular,score,fill=list(count=0))
ggplot(data=temp_data,aes(x=whichrep_polygon,y=whichrep_modular)) +
  geom_tile(aes(fill=count)) +
  scale_fill_continuous(low="#000044",high="#FF5555") +
...
temp_data = whichrep_data[!is.na(whichrep_data$whichrep_polygon) & grepl('4agenerator',gsub(' ','',whichrep_data$question)),] %>% group_by(score,whichrep_polygon,whichrep_modular) %>% summarize(count = n()) %>% complete(whichrep_polygon,whichrep_modular,score,fill=list(count=0))
ggplot(data=temp_data,aes(x=whichrep_polygon,y=whichrep_modular)) +
  geom_tile(aes(fill=count)) +
  scale_fill_continuous(low="#000044",high="#FF5555") +
...
temp_data = whichrep_data[!is.na(whichrep_data$whichrep_polygon) & grepl('Trueorfalse',gsub(' ','',whichrep_data$question)),] %>% group_by(score,whichrep_polygon,whichrep_modular) %>% summarize(count = n()) %>% complete(whichrep_polygon,whichrep_modular,score,fill=list(count=0))
ggplot(data=temp_data,aes(x=whichrep_polygon,y=whichrep_modular)) +
  geom_tile(aes(fill=count)) +
  scale_fill_continuous(low="#000044",high="#FF5555") +
