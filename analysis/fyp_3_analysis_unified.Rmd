...
print(paste("theta: ",theta,", phi: ",phi,', BIC: ', log(100)*1-2*log_likelihood_of_full_data(hierarchical_data,theta,phi)))
...
print(paste("theta: ",theta,", phi: ",phi,', BIC: ', log(100)*2-2*log_likelihood_of_full_data(hierarchical_data,theta,phi)))
